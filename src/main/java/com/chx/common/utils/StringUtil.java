...
public class StringUtil {
	...
	public static String getValue(String str,int start){
	    ...
	    // 我爱我家 经过处理后,返回 我爱**
		 ...
		 for (int i = 0; i < s1.length(); i++) {
			// str = str.replace(String.valueOf(str.charAt(i)),"*");   //全部为****
			 s2+="*";
		}
	...
	public static String generateChineseName(){
		String[] str={"赵","钱","孙","李","周","吴","郑","王","冯","陈","楮","卫","蒋","沈","韩","杨","朱","秦",
				...
				"鲜于","闾丘","司徒","司空","丌官","司寇","仉","督","子车","颛孙","端木","巫马","公西","漆雕","乐正",
				"壤驷","公良","拓拔","夹谷","宰父","谷梁","段干","百里","东郭","南门","呼延","归","海","羊舌","微生",
				"梁丘","左丘","东门","西门","南宫"};
